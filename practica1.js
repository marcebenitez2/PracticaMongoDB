...
db.libros.find({autor: "Borges"}).pretty();

// 8 - Solo mostrar los 2 primeros documentos
db.libros.find().limit(2).pretty();
...
db.libros.updateMany({codigo:{$in:[2,3,4]}}, {$set: {precio: 50, cantidad: 12}});
